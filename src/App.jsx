...
let colors = {
  ink: "#2B1B0E", bg: "#E9E2D0", surface: "#FBF6ED", cream: "#2B1B0E",
...
const THEMES = {
  ...
  daylight: { name: "Classic Light", ink: "#2B1B0E", bg: "#E9E2D0", surface: "#FBF6ED", cream: "#2B1B0E", sunset: "#E8622C", gold: "#D4A72C", forest: "#3F7D5C", charcoal: "#22262E", muted: "#9A8F7A", line: "#EDE6D6" },
};
